...
GO
GRANT EXECUTE ON XML SCHEMA COLLECTION:: [dbo].[schema_collection_Performance Counters Collector Type] TO [dc_admin]
GO
GRANT VIEW DEFINITION ON XML SCHEMA COLLECTION:: [dbo].[schema_collection_Performance Counters Collector Type] TO [dc_admin]
GO
